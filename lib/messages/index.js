...
function Messages(options) {
  ...
  //console.log("################### Messages options.network : " + JSON.stringify(options.network) );
  //console.log("################### Messages bitcore.Networks.defaultNetwork : " + JSON.stringify(bitcore.Networks.defaultNetwork) );
  
  this.network = options.network || bitcore.Networks.defaultNetwork;
  //console.log("################### Messages constructor end :" );
}
